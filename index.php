  ...
  <div class="wrapper">
    ...
    <div class="main_body">
      ...
      <div class="container">
        ...
        <div class="card" style="background-color: #0779e4; color: white; margin-top: 20px;">
          <p>
            Melihat Daftar barang pada menu
            <span style="color: #ffcd3c;">Daftar Barang</span>
          </p>
        </div>
        <div class="card" style="background-color: #ffcd3c; color: white; margin-top: 20px;">
          <p>
            Jangan sampai salah mengubah data !!!
          </p>
        </div>
        <div class="card" style="background-color: #fa1616; color: white; margin-top: 20px;">
          <p>
