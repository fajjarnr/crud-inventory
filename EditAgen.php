...
$data = query("SELECT * FROM agen WHERE id = $id")[0];
          ...
          <div class="card-body">
            <form action="" method="POST" class="form">
              ...
              <div class="form-group">
                ...
                <input type="text" name="tlp" value="<?= $data["tlp"] ?>" class="input-text" placeholder="Masukan No. Telepon" required />
              </div>
              <div class="form-group">
                <label for="alamat">Alamat Agen</label>
                <input type="text" name="alamat" value="<?= $data["alamat"] ?>" class="input-text" placeholder="Masukan ALamat Agen" required />
              </div>
